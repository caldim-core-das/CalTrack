      ...
      <div className="uc-section">
        ...
        {filtered.length === 0 && (
          <div style={{ textAlign:"center", padding:"3rem", color:"#94a3b8" }}>
            ...
            <p style={{ fontWeight:600, fontSize:"0.9rem" }}>No services found for "{search}"</p>
          </div>
        )}
      </div>
...
function LiveTrackingPage({ successData, technician, category, cart, formData, selDate, selTime, onBookAgain }) {
  ...
  const trackSteps = [
    ...
    { label:"Expert Assigned",   icon:"👨‍🔧", done:true, time:"Just now" },
    { label:"Expert On The Way", icon:"🛵", done:false, time:`~${etaMinutes} min` },
      ...
      <header className="uc-nav">
        ...
        <div className="uc-nav-right-icons">
          ...
          <div className="uc-cart-icon" 
            ...
            <div onClick={() => step > 1 && setStep(6)} style={{ display:'flex', alignItems:'center', height:'100%' }}>
...
function BkStyles() {
  return (
    <style>{`
      ...
      /* ── HERO ── */
      .uc-search-bar {
        width: 350px; display:flex; align-items:center; gap:0.5rem;
        background:#f8fafc; border:1px solid #e2e8f0; border-radius:8px;
        padding:0.4rem 0.75rem;
      }
      .uc-search-bar input {
        border:none; background:transparent; outline:none; font-size:0.8rem; width:100%;
        color:#1e293b;
      }
      .uc-nav-right-icons { display:flex; align-items:center; gap:1.25rem; }
      .uc-cart-icon, .uc-profile-icon { position:relative; cursor:pointer; display:flex; align-items:center; justify-content:center; }
      .uc-cart-badge {
